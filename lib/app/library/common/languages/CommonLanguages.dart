class CommonLanguages {
  ...
  static Map<String, String> englishWords = {
    ...
    "notification.action.createdShortcut": "Shortcut created successfully",
    "notification.action.deletedShortcut": "Shortcut deleted successfully",
  ...
  static Map<String, String> russianWords = {
    ...
    "notification.action.createdShortcut": "Ярлык успешно создан",
    "notification.action.deletedShortcut": "Ярлык успешно удален",
  ...
  static Map<String, String> vietnameseWords = {
    ...
    "notification.action.createdShortcut": "Đã tạo lối tắt thành công",
    "notification.action.deletedShortcut": "Đã xóa lối tắt thành công",
  ...
  static Map<String, String> portugueseWords = {
    ...
    "notification.action.createdShortcut": "Atalho criado com sucesso",
    "notification.action.deletedShortcut": "Atalho excluído com sucesso",
  ...
  static Map<String, String> spanishWords = {
    ...
    "notification.action.createdShortcut": "Acceso directo creado con éxito",
    "notification.action.deletedShortcut": "Acceso directo eliminado con éxito",
  ...
  static Map<String, String> chineseWords = {
    ...
    "notification.action.createdShortcut": "快捷方式创建成功",
    "notification.action.deletedShortcut": "快捷方式删除成功",
  ...
  static Map<String, String> japaneseWords = {
    ...
    "notification.action.createdShortcut": "ショートカットが正常に作成されました",
    "notification.action.deletedShortcut": "ショートカットが正常に削除されました",
  ...
  static Map<String, String> indonesianWords = {
    ...
    "notification.action.createdShortcut": "Pintasan berhasil dibuat",
    "notification.action.deletedShortcut": "Pintasan berhasil dihapus",
  ...
  static Map<String, String> frenchWords = {
    ...
    "notification.action.createdShortcut": "Raccourci créé avec succès",
    "notification.action.deletedShortcut": "Raccourci supprimé avec succès",
  ...
  static Map<String, String> koreanWords = {
    ...
    "notification.action.createdShortcut": "바로 가기가 성공적으로 생성되었습니다",
    "notification.action.deletedShortcut": "바로 가기가 성공적으로 삭제되었습니다",
